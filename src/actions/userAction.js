...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/customer/me/update`, userData, config);
...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/customer/admin/users`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/customer/admin/user/${id}`);
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/customer/admin/user/${id}`);
